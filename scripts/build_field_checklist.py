...
CONTENT_EN = {
    ...
    "blocks": [
        ...
        ("item", "Auto Seq enabled, so message sequencing runs by itself"),
        ("item", "\u201cDisable Tx after sending 73\u201d unchecked, so CQ resumes without a click"),
        ("note", "Tx Watchdog stops transmission after 6 quiet minutes. That is a safety feature, not a fault."),
        ...
        ("sub", "Sending a custom message instead of 73"),
        ("item", "Type it only once the QSO has reached the 73 stage"),
        ("item", "Untick Auto Seq for that one transmission"),
        ("item", "Tick Auto Seq back on immediately afterwards"),
        ("note", "Forget the last step and automatic sequencing quietly stops for the rest of the session."),
        ...
        ("table", ("Mistake", "Consequence"), [
            ...
            ("Leaving Auto Seq off after a custom Tx5 message",
             "Automatic sequencing stops silently for the rest of the session"),
        ]),
    ],
}
...
CONTENT_NL = {
    ...
    "blocks": [
        ...
        ("item", "Auto Seq staat aan, zo verloopt de berichtvolgorde vanzelf"),
        ("item", "\u201cDisable Tx after sending 73\u201d uitgevinkt, zo hervat CQ zonder klik"),
        ("note", "Tx Watchdog stopt het zenden na 6 stille minuten. Dat is een beveiliging, geen fout."),
        ...
        ("sub", "Een eigen bericht sturen in plaats van 73"),
        ("item", "Pas typen wanneer de QSO aan het 73-punt is"),
        ("item", "Auto Seq uitvinken voor die ene zending"),
        ("item", "Auto Seq er meteen daarna weer aanzetten"),
        ("note", "Vergeet je die laatste stap, dan stopt de automatische volgorde stilletjes voor de rest van de sessie."),
        ...
        ("table", ("Fout", "Gevolg"), [
            ...
            ("Auto Seq vergeten terug aan te zetten na een eigen Tx5-bericht",
             "De automatische berichtvolgorde stopt stil voor de rest van de sessie"),
        ]),
    ],
}
